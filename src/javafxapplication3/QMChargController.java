 ...
 * @author saiyen
 */
public class QMChargController implements Initializable { /// Controleur de la question moyenne pour la chargement d'une partie
   ...
   p1.setOnMouseClicked(k->
     ...
     public void confirmer() throws IOException
    {
         ...
         ans = QMChargController.answer;
         n= this.compterPoints(questionP, this.answer, ChargementPartieController.Jcourant, Difficultés.Moyen);
        ...
        FXMLLoader myLoader = new FXMLLoader(getClass().getResource("De2.fxml"));
