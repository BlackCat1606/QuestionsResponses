 ...
 * @author saiyen
 */
public class QuestDifficileController implements Initializable {/// Controleur de la question difficile pour la partie
    ...
    public void initialize(URL url, ResourceBundle rb) {
         ...
         QuesD.setText(this.questionP.getQuestion()); /// init de la question posée 
        Confirmer.setDisable(true);
        /// Listner pour le boutton confirmer
...
public void confirmer() throws IOException //// Vérifications aprés confirmation de la réponse 
    {
         ...
         System.out.println("this is it : "+this.answer);
          ...
          ans = QuestDifficileController.answer;
