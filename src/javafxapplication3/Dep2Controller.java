...
import static javafxapplication3.ChargementPartieController.parcours;
...
import static javafxapplication3.QFChargController.n;
;
 ...
 * @author saiyen
 */
public class Dep2Controller implements Initializable {/// Controleur du deplacement pour le chargement de partie
   ...
   public static  int Nbr_QCh = 0;
    ...
    public void get_dep(ActionEvent e)
    {
    ...
    if(c.getNuméro()<=42 && c.getNuméro()>=22 && c.getOccupant()!=null)
          {
                ...
                /// Lancer le challenge
                 ...
                 FXMLLoader myLoader = new FXMLLoader(getClass().getResource("Duel2.fxml"));
                 Duel2Controller controller = (Duel2Controller) myLoader.getController();
      ...
      //  parcours.get(Jcourant.getAvancement()-1).setOccupant(A);
        ...
        ChargementPartieController.Namej.setText("Le tour est à : "+Jcourant.getNom());
